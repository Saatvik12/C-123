...
#to convert png jpg image into the interpriter format
from PIL import Image
import PIL.ImageOps
import os,ssl,time
#setting and https context to fetch data from openml
#ssl in secure socket layer
#if envirment is not created, then alsoprogram will run on diffrent opperatng system
#we are creating a send box which will be temprery and it's kind of virtual stage which doesn't affect regular operating system
...
while(True):
    try:
        ...
        #DRAWING A BOX IN THE CENTER OF VIDEOSO THAT SOFTWARE RECAGENIZE THE DIGIT IN THAT SMALL AREA ONLY
